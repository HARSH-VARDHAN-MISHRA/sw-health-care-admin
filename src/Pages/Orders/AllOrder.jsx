...
const AllOrder = () => {
    ...
    const handleFetch = async () => {
        try {
            const res = await axios.get('https://sw-health-care-backend.onrender.com/api/v1/all-order');
    ...
    const handleDelete = async (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    await axios.delete(`https://sw-health-care-backend.onrender.com/api/v1/delete-order/${id}`);
